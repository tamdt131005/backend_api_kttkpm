...
Background:
    ...
    * def token = response.token
    ...
    # Chuyển sang API nhập hàng
    * url baseUrl + '/api/admin/nhaphang'
    * header Authorization = 'Bearer ' + token
    * header Content-Type = 'application/json'

#######################################################
# TC01 - Lưu phiếu nhập thành công
#######################################################
...
* print response
#######################################################
# TC02 - Biến thể không hợp lệ
#######################################################

Scenario: TC02 - Biến thể để trống
